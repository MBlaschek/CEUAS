            ...
            for k in cdmd.keys(): # loop over all the table definitions e.g. ['id_scheme', 'crs', 'station_type', 'observed_variable', 'station_configuration', 'station_configuration_codes', 'observations_table', 'header_table']
                ...
                for i in range(len(cdmd[k])): 
                    ...
                    if k in ('observations_table'):
                        ...
                        try:   
                            ...
                            if len(sci)>0:
                                ...
                                print('station id else: len(sci)=0')
                    ...
                    try:
                        ...
                        print(' I am trying: ', k , d.element_name, groups.keys() )                        
                        log_file.write('k_d.element_name_error_'  + fn + '\n') 
                        print('bad k_d.element_name_error_ FFFF :', k, d.element_name)
...
def odb_to_cdm(cdm, cdmd, output_dir, fn):
    ...
    station_id_fails = open('station_id_fails.log','a') # here I wrtie the stations for which the station id cannot be found in the station_configuration file 
...
if __name__ == '__main__':
    ...
    if dataset == 'test':
        ...
        #for s in db.keys():
        for s in ['era5_1', 'era5_1759', 'era5_3188', 'era5_1761', 'bufr', 'igra2', 'ncar'] :
        ...
        for d in datasets:
            ...
            files_list = filelist_cleaner(files_list, d)[5:6] 
                        
            print('*** Check files list: ', files_list)
            if 'era5' in d and 'bufr' not in d:   
                odb_to_cdm(cdm_tab, cdm_tabdef, output_dir, files_list[0])
                ...
                df_to_cdm(cdm_tab, cdm_tabdef, output_dir, files_list[0])
