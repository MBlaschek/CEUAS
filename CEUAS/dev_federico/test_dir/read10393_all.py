...
#    func = partial(par_read_odbsql_stn_nofeedback,varno)
    ...
    #func = partial(readstationfiles_t,'header',os.path.expandvars('$FSCRATCH/ei6/'),'ERA5_'+exp+'_',varlist=varlist)
        ...
        func = partial(readstationfiles_t,'header',os.path.expandvars('Station_10393/'+exp),'ERA5_'+exp+'_',varlist=varlist)
        print('Done with FF', exp , varlist)
    else:
        func = partial(readstationfiles_t,'header',os.path.expandvars('Station_10393/'+exp), exp+'_',varlist=varlist)
