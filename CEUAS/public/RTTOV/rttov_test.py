...
#     for i in ["RISE", "RASE"]: #[None, "RAOBCORE", "RICH", "RISE", "RASE"]:
    ...
    i = None
    statlist = glob.glob('/mnt/ssdraid/scratch/leo/rise/1.0/exp01/*65344*/feedbackmerged*.nc')
    print(statlist)
    for j in statlist:
        print(j)
