...
#                     dates.append(mon)
        ...
        try:
            ...
            pass
        if day:
            pickle.dump( refl, open( "rttov_out_ih/"+statid+"/IGRAH_"+statid+"_day_refl.p", "wb" ) )
            pickle.dump( dates, open( "rttov_out_ih/"+statid+"/IGRAH_"+statid+"_day_dates.p", "wb" ) )
            pickle.dump( chan_list, open( "rttov_out_ih/"+statid+"/IGRAH_"+statid+"_day_chan_list.p", "wb" ) )
            print('done: '+statid)
        else:
            pickle.dump( refl, open( "rttov_out_ih/"+statid+"/IGRAH_"+statid+"_night_refl.p", "wb" ) )
            pickle.dump( dates, open( "rttov_out_ih/"+statid+"/IGRAH_"+statid+"_night_dates.p", "wb" ) )
            pickle.dump( chan_list, open( "rttov_out_ih/"+statid+"/IGRAH_"+statid+"_night_chan_list.p", "wb" ) )
            print('done: '+statid)
#     except:
#         print('error: '+statid)
