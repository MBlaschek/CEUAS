...
def calc_bin_and_chunk(full,allindices,i,bins,weights,date_listm):
...
#    fns=['/home/srvx7/leo/fastscratch/ei6/'+st+'/feedbackmerged'+st+'.nc',]
    ...
    for i in range(1,len(allindices)):
        ...
        bins,goods,chunk,chunko=calc_bin_and_chunk(full,allindices,i,bins,weights,date_listm)
