...
| ---------------- | ------------------- | ---------------- | ------------------------------------------------------------ | -------------- | ------------------------------------------------------------ |
| `variable`       | Mandatory           | Same             | `[temperature, u_component_of_wind, v_component_of_wind, wind_speed, wind_direction, ,geopotential, relative_humidity, specific_humidity, dew_point_depression, dew_point_temperature]` | String         | Meteorological variables                                     |
