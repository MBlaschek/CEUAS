...
class CDMDataset:
    ...
    def read_write_request(self, filename_out: str, request: dict, cdm_dict:dict):
        ...
        try:
            ...
            logger.error('Exception %s occurred while reading %s', repr(e), self.filename)
            raise RuntimeError('exception "{}" occurred while reading {}'.format(e, self.filename))
    ...
    def read_observed_variable(self, varnum: int,
        ...
        Args:
            varnume: 85 or 2 for temperature
