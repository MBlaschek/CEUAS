                ...
                with h5py.File(rfile, 'r') as f:
                    ...
                    if False:
                        ...
                        try:
                            ...
                            dsec = []
                            for d in sdate:
                                dsec.append(((datetime.datetime(year=d // 10000, month=d % 10000 // 100,
                                                                day=d % 100) - datetime.datetime(year=1900, month=1,
                                                                                                 day=1))).days * 86400)
                            if len(dsec) == 1:
                    ...
                    with h5py.File(dfile, 'w') as fd:
                        ...
                        fd.attrs['history'] = numpy.string_(
                            'Created by Copernicus Early Upper Air Service Version 0, ' + datetime.datetime.now().strftime(
                                "%d-%b-%Y %H:%M:%S"))
