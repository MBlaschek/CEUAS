...
def read_standardnames(url: str = None) -> dict:
    ...
    cf['latitude']['description'] = 'Latitude of the observed value, -90 to 90. This may or may not be the same as the report location.'
    cf['longitude']['shortname'] = 'lon'
    cf['longitude']['description'] = 'Longitude of the observed value, -180 to 180. This may or may not be the same as the report location.'
    cf['air_pressure']['shortname'] = 'plev'
    cf['time']['shortname'] = 'time'
    cf['time']['description'] = 'timestamp for observation'
    cf['bias_estimate']['cdsname'] = 'bias_estimate'
    cf['bias_estimate']['cdmcode'] = 0
    cf['bias_estimate']['odbcode'] = 0
    cf['bias_estimate']['description'] = 'radiance bias correction'
    cf['obs_minus_bg']['cdsname'] = 'obs_minus_bg'
    cf['obs_minus_bg']['cdmcode'] = 0
    cf['obs_minus_bg']['odbcode'] = 0
    cf['obs_minus_bg']['description'] = 'observed minus first guess value'
    cf['obs_minus_an']['cdsname'] = 'obs_minus_an'
    cf['obs_minus_an']['cdmcode'] = 0
    cf['obs_minus_an']['odbcode'] = 0
    cf['obs_minus_an']['description'] = 'observed minus analysed value'
    cf['air_temperature']['cdsname'] = 'temperature'
    cf['air_temperature']['cdmcode'] = cdm_codes['temperature']
    cf['air_temperature']['odbcode'] = 2
    cf['air_temperature']['description'] = 'Air temperature (from profile measurement)'
    ...
    cf['eastward_wind']['description'] = 'Eastward wind speed (from profile measurement)'
    ...
    cf['northward_wind']['description'] = 'Northward wind speed (from profile measurement)'
    cf['wind_speed']['cdsname'] = 'wind_speed'
    cf['wind_speed']['cdmcode'] = cdm_codes['wind_speed']
    cf['wind_speed']['odbcode'] = 112
    cf['wind_speed']['description'] = 'Speed is the magnitude of velocity. Wind is defined as a two-dimensional (horizontal) air velocity vector,  with no vertical component. (Vertical motion in the atmosphere has the standard name upward air velocity.) The wind speed is the magnitude of the wind velocity.'
    ...
    cf['wind_from_direction']['description'] = 'direction from which the wind is blowing'
    ...
    cf['relative_humidity']['description'] = 'Relative humidity (from profile measurement)'
    ...
    cf['specific_humidity']['description'] = 'specific means per unit mass. Specific humidity is the mass fraction of water vapor in (moist) air.'
    ...
    cf['dew_point_temperature']['description'] = 'Dewpoint measurement (from profile measurement)'
    cf['geopotential']['cdsname'] = 'geopotential'
    cf['geopotential']['cdmcode'] = cdm_codes['geopotential']
    cf['geopotential']['odbcode'] = 1
    cf['geopotential']['description'] = 'height of a standard or significant pressure level in meters'
    cf['trajectory_label']['shortname'] = 'trajectory_label'
    cf['trajectory_label']['description'] = 'Unique ID for report (unique ID given by combination of report_id and observation_id)'
    cf['sonde_type']['shortname'] = 'sonde_type'
    cf['sonde_type']['description'] ='Link to sensor_configuration table.'
    cf['sample_size']['shortname'] = 'sample_size'
    cf['sample_size']['description'] = 'Secondary variable required to understand observation, e.g. chemical constituent. Set to NA / missing if not applicable.'
    cf['sample_error']['shortname'] = 'sample_error'
    cf['sample_error']['description'] = "Original reporting precision in units given by 'original_units'"
    cf['report_id']['shortname'] = 'report_id'
    cf['report_id']['description'] = 'Link to header information'
    cf['reference_sonde_type']['shortname'] = 'reference_sonde_type'
    cf['reference_sonde_type']['description'] = 'Link to sensor_configuration table for reference sensor.'
    cf['station_name']['shortname'] = 'station_name'
    cf['station_name']['description'] = 'Name of station (e.g. Tateno)'
    cf['RISE_bias_estimate']['shortname'] = 'RISE_bias_estimate'
    cf['RISE_bias_estimate']['description'] = 'Temperature bias adjustments depending on solar elevation, calculated from neighbour composite (Haimberger et al. 2012)'
    cf['RICH_bias_estimate']['shortname'] = 'RICH_bias_estimate'
    cf['RICH_bias_estimate']['description'] = 'Temperature bias adjustments (constant between breakpoints), calculated from neighbour composite (Haimberger et al. 2012)'
    ...
    cf['desroziers_30']['description'] = 'Observation error estimated from ERA5 background and analysis departure statistics (Desroziers, 2005), using a 30 day window'
    cf['desroziers_60']['shortname'] = 'desroziers_60'
    cf['desroziers_60']['description'] = 'Observation error estimated from ERA5 background and analysis departure statistics (Desroziers, 2005), using a 60 day window'
    cf['desroziers_90']['shortname'] = 'desroziers_90'
    cf['desroziers_90']['description'] = 'Observation error estimated from ERA5 background and analysis departure statistics (Desroziers, 2005), using a 90 day window'
...
#         text += "\nPermissions: %s%s (%s)" % ('R' if os.access(self.filename, os.R_OK) else '', 'W' if os.access(self.filename, os.W_OK) else '', os.getlogin())
    ...
    def read_write_request(self, filename_out: str, request: dict, cf_dict: dict):
        ...
        if restriction_active:
            # check if everything is restricted - if so -> error
            if restricted_dim.shape[0] == 0:
