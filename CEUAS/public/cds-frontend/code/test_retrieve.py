...
#
for variable in ["air_temperature", ["air_temperature"],
                 ["zonal_wind", "meridional_wind", "wind_speed", "wind_direction", "air_relative_humidity",
...
for d in ['', ["20140105"], ["20140102-20150105"], ["20130101", "20140104", "20140105", "20140107"]]:
    if d == '':
        ...
        slist = [[22, 23, 0, 1, 2, 3], ["22", "23", "00", "01", "02", "03"], '', '0', "00", ["00"], [0, 12],
                 ["0", "12"], "00-12", "0-12", "0-0", "11-11", ["00-12"], ["21-03"], ["15-03"], ["09-15"], ["18-06"],
                 ["6-18"]]
