...
Observation_file = os.path.join(cdm_git_root, 'table_definitions','observations_table.csv')
Variables_file   = os.path.join(cdm_git_root, 'tables','observed_variable.dat')
