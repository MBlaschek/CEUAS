import os,sys
import argparse
from harvest_to_netCDF_converter_leo_federico import db
...
out_dir = '/raid60/scratch/federico/IGRA2_27Jan2020_RERUN'
processes =10
...
if datasets == 'test':
  ...
  for d in datasets:
    ...
    for c in chunks:
           ...
           os.system('/opt/anaconda3/bin/python3  harvest_to_netCDF_converter_leo_federico.py  -d ' + d + ' -o ' + out_dir + ' -f ' + c + ' & ')                                                                                                                                 
