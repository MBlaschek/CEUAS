...
def odb_cdm(ci,cdm,cdmd,unified,vola,chuan,igrainv,wbaninv,trans, dataset, fn):  
    ...
    output_list_file = open('/raid8/srvx1/federico/GitHub/DELETABLE/CEUAS_master/CEUAS/meta/inventory0/code/' + dataset + '_stationsId_filename.txt', 'a+')
...
def read_bufr_stn_meta(varno, bufrfile):
    ...
    output_list_file = open('/raid8/srvx1/federico/GitHub/DELETABLE/CEUAS_master/CEUAS/meta/inventory0/code/bufr_stationsId_filename.txt', 'a+')
    output_list_file.seek(0)
...
def read_rda_meta(ncfile):
    ...
    output_list_file = open('/raid8/srvx1/federico/GitHub/DELETABLE/CEUAS_master/CEUAS/meta/inventory0/code/ncar_stationsId_filename.txt', 'a+')
    output_list_file.seek(0)
...
def read_igra_meta(line):
    ...
    output_list_file = open('/raid8/srvx1/federico/GitHub/DELETABLE/CEUAS_master/CEUAS/meta/inventory0/code/igra2_stationsId_filename.txt', 'a+')
    output_list_file.seek(0)
