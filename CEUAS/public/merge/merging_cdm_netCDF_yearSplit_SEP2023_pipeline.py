...
if __name__ == '__main__':
    ...
    if parameter_file != '.': 
        ...
        from modded_merging_yearly_parameters import  merged_out_dir,  data_directories, run_exception, pool_number, check_missing_stations
        from modded_merging_yearly_parameters import   add_sensor, stations, station_kind, create_merging_list, scpath
    else:
