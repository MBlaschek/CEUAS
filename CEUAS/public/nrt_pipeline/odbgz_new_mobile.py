...
for patt in f'/mnt/users/scratch/uvoggenberger/CUON_HARVEST_202503/data/era5_1_data/era5.conv.{year}{month}.[A-Z]????',\
    f'/mnt/users/scratch/uvoggenberger/CUON_HARVEST_202503/data/era5_1_data/era5.conv.{year}{month}.????', f'/mnt/users/scratch/uvoggenberger/CUON_HARVEST_202503/data/era5_1_data/era5.conv.{year}{month}.??????',\
    f'/mnt/users/scratch/uvoggenberger/CUON_HARVEST_202503/data/era5_1_data/era5.conv.{year}{month}.???????',  f'/mnt/users/scratch/uvoggenberger/CUON_HARVEST_202503/data/era5_1_data/era5.conv.{year}{month}.????????':
#    if '.gz' in patt:
#        continue
