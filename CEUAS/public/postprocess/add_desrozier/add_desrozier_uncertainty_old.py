...
class Desroziers():
    ...
    def __init__(self, out_dir = '' , station_id = '' , file='' ):
        ...
        self.variables = [36,38,39,85,104,105,106, 107]
        # 30 dew point temp, 38 relative hum, 39 specific hum                                                                                                
        # 104,105 u and v wind, 106 wind from direction, 107 wind speed
    ...
    def write_output(self):
        ...
        a = open('Desroziers_processed.txt', 'a')
        a.write(self.file)
...
out_dir = '/raid60/scratch/federico/DESROZIERS_JUNE2021_onlygroup'
...
if __name__ == '__main__':
            ...
            #cleaned_list = ['0-20000-0-10460_CEUAS_merged_v1.nc', '0-20000-0-0-246-0-101004_CEUAS_merged_v1.nc', '0-20300-0-USI0000KRPD_CEUAS_merged_v1.nc']
            print(cleaned_list)
            #m = '/raid60/scratch/federico/MERGED_JUNE2021/'
            #cleaned_list = [f for f in os.listdir(m) if os.path.getmtime(m+'/'+f) > 1623922931.4909277 and 'Sensor' not in f ][50:]
            
            
            print("*** Processing: " , len(cleaned_list) , "   files ")

            if multiproc in ['yes', 'y', 'YES', 'Y', 'True', 'true', 'T']:
                p = Pool(10)
