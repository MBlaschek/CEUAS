...
def calc_station(statid, chum, adj = None):
    ...
    try:
        ...
        if adj == None:
            ...
            pickle.dump( wholemon[:middle_index], open( "rttov_out/"+adj+"_"+statid+"/"+statid+"_day_dates.p", "wb" ) )
        ...
        if adj == None:
            ...
            pickle.dump( [197901], open( "rttov_out/"+adj+"_"+statid+"/"+statid+"_day_dates.p", "wb" ) )
