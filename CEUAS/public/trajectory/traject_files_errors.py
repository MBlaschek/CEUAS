...
def write_trj(stat):
    ...
    try:
        ...
        checkfile = glob.glob('/mnt/users/staff/uvoggenberger/scratch/converted_v11/trajectory_files_new/*'+str(stat.split('/')[-1]))
        if len(checkfile) > 0:
            return 1
...
if __name__ == '__main__':
    ...
    # for i in glob.glob('/mnt/users/scratch/leo/scratch/converted_v11/long/*02181*.nc')[:]:
