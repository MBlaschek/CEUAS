...
def trend_station(i, dt_from, dt_to):
    ...
    try:
        ...
        with h5py.File(i, "r") as file:
            ...
            mask = masks["specific_humidity"]
            t_idx = idx_d["specific_humidity"]
...
for dts, dte in [("1993-01-01", "2022-12-31"), ("1973-01-01", "2002-12-31")]: # , ("1958-01-01", "1987-12-31")
    ...
    pickle.dump(results, open("polyfit_trends_specific_humidity_700hPa_"+dts+"_"+dte+"_Trend_20230817.p", "wb"))
    ray.shutdown()
