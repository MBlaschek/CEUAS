...
def trend_station(i, dt_from, dt_to):
    ...
    try:
        ...
        with h5py.File(i, "r") as file:
            ...
            mask = masks["eastward_wind"]
            t_idx = idx_d["eastward_wind"]
            ...
            if len(temp) > 0:
                ...
                temp["adjusted"] = (
                    temp["observation_value"] - temp["wind_bias_estimate"]
                )
                temptime = temp.time
...
for dts, dte in [("1994-01-01", "2023-12-31"), ("1973-01-01", "2002-12-31"), ("1958-01-01", "1987-12-31")]:
    ...
    pickle.dump(results, open("/users/staff/uvoggenberger/scratch/CUON_trends/polyfit_trends_u_700hPa_"+dts+"_"+dte+"_Trend_20240422.p", "wb"))
    ray.shutdown()
